        ...
        <Row className="footer_row">
          ...
          <Col md={3} className="footer_col">
            <div className="footer-logo mb-3">
              <Link to="/">
                <img src={logo} alt="ABC Restaurant Logo" className="footer-logo-img" />
              </Link>
            </div>
            <p>Experience exceptional dining at ABC Restaurant with our exquisite meals and warm service.</p>
